	...
	receivedPostback: function (event) {
	  ...
	  switch(payload){
	  	case 'GETTING_STARTED':{
	  		sendGettingStartedMessage(senderID);
	  		break;
	  	}
	  	default:{
...
function sendGettingStartedMessage(recipientId){
	var firstTimeGreeting = "Hello, I am Arabot! I will help you choose the next movie or series to watch. What would you like to watch?";
	var foreignMovie = "Foreign Movie";
	var foreignSeries = "Forein Series";
	var turkishSeries = "Turkish Series";
	...
	var messageData = {
	  ...
	  "message":{
	    "text": arabicText[firstTimeGreeting],
	    "quick_replies":[
	      {
	        "content_type":"text",
	        "title": arabicText[foreignMovie],
	        "payload":"Picked " + foreignMovie
	      },
	      {
	        "content_type":"text",
	        "title": arabicText[foreignSeries],
	        "payload":"Picked " + foreignSeries
	      },
	      {
	        "content_type":"text",
	        "title": arabicText[turkishSeries],
	        "payload":"Picked " + turkishSeries
	      }	      
	    ]
	  }
	};
