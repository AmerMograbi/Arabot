...
var arabicText = require('./arabic-text.json');
...
module.exports = {
	  ...
	  if (messageText) {
	  	...
	  	if(messagePayload){
	  		...
	  		if(stage[messagePayload]){
	  			sendTextMessage(senderID, arabicText.whatToWatch);
	  		}
	  	}
...
function sendGettingStartedMessage(recipientId){
	var messageData = {
	  ...
	  "message":{
	    "text": "tes1",//arabicText.firstGreeting,
	    "quick_replies":[
	      {
	        "content_type":"text",
	        "title": "tes2",//arabicText.foreignMovie,
	        "payload": "foreignMovie"
	      },
	      {
	        "content_type":"text",
	        "title": "tes3",//arabicText.foreignSeries,
	        "payload": "foreignSeries"
	      },
	      {
	        "content_type":"text",
	        "title": "tes4",//arabicText.turkishSeries,
