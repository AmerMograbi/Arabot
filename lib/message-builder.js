...
function buildGenericTemplateShowMessage(recipientId, chosenShowType, chosenGenre) {
	return new Promise((resolve, reject) => {
		...
		.then(show => {
			...
			const buttons = getShowButtons(show.description, show._id, recipientId, chosenShowType, chosenGenre);
...
function getShowButtons(showDescription, showDbId, userId, showType, genre) {
	const buttonData = arabicText[showButtons];
	let buttons = [];
	...
	const willWatchPayload = JSON.stringify(buildWillWatchPayload(showDbId, userId, showType, genre));
...
function buildWillWatchPayload(showDbId, userId, showType, genre) {
	return {
		willWatch: showDbId,
		userId: userId,
		showType: showType,
