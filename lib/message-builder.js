			...
			case "moreInfoResponse":
				{
					...
					if(chosenResponse.hasOwnProperty("liked")){
...
//The content built here will be used for payloads instead of 'arabic-text.json'.
//the arabic text itself will still be brought from 'arabic-text.json'
